    ...
    render() {
        return (
            <section style={{height:`100vh`, width:`calc(100vw - (100vw - 100%))`,  position:`relative`, overflow:`hidden`}}>
                ...
                {/* Here HIDE the landing Icons completely */}
